...
export const InviteFriendsHome = () => {
                        ...
                        <CarouselItem className="w-full h-full">
                            <div className="w-full h-full flex md:!flex-row flex-col justify-evenly ml-4">
                                <div className="md:w-full md:h-full flex justify-center flex-col">
                                    <div className="w-full text-3xl text-gray-600 dark:text-white font-semibold">Topluluğunuzu büyütün</div>
                                    <div className="text-gray-500 dark:text-gray-300 mt-8 tracking-wide">Topluluğunuza insanları davet edin. Sunucuna katılmaları için bir davet bağlantısı oluştur ve arkadaşlarınla paylaş.</div>
                                </div>
                                        ...
                                        <CarouselContent className="w-full ">
                                            <CarouselItem className="w-full ">
                                                <div className="aspect-video transition-all bg-gray-500 w-full rounded-xl overflow-hidden border-[1px] border-gray-800 dark:border-gray-700">
                                                    <picture>
                                                        <img src="if0.png" className="w-full h-full object-cover" />
                                                    </picture>
                                                </div>
                                            </CarouselItem>
                                            <CarouselItem className="w-full ">
                                                <div className="aspect-video transition-all bg-gray-500 w-full rounded-xl overflow-hidden border-[1px] border-gray-800 dark:border-gray-700">
                                                    <picture>
                                                        <img src="if1.png" className="w-full h-full object-cover" />
                                                    </picture>
                                                </div>
                                            </CarouselItem>
                                        </CarouselContent>
